...
![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-build-configuration-menu.png?raw=true)
...
1. 對專案點選右鍵按「發佈」。
    ...
    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-project-publish-menu.png?raw=true)

2. 點擊「新增發佈設定」。

    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-new-profile.png?raw=true)

3. 這篇文章只講資料夾發佈，所以選擇資料夾。

    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-target-folder.png?raw=true)

4. 設定輸出資料夾，我習慣上會設定成「bin\Publish\{組態名稱}」，這邊設定成「bin\Publish\Release」。

    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-location-setting.png?raw=true)

5. 後續新增完建議更改發佈檔名稱，建議和組態名稱一致或有簡易說明。

    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-profile-rename.png?raw=true)

6. 編輯發佈設定，基本的設定可以使用 UI 編輯，這邊我會全打勾，實務上請依需求調整，像是如果是使用發佈到網站，又設定成「發佈前刪除所有的檔案」會造成網站上的儲存的暫存檔案(e.g. 上傳的檔案)都被一併刪除。

    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-profile-settings.png?raw=true)
...
7. 可以直接修改 XML 變更發佈的設定，例如增加`<ExcludeFilesFromDeployment>packages.config;Scripts\_references.js</ExcludeFilesFromDeployment>`，使之在發佈時，排除特定檔案，至於 XML 具體有哪些發佈設定，目前並無在 MSDN 上查到相關說明。
    ...
    ![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-profile-preview.png?raw=true)
...
![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-add-config-transform.png?raw=true)

* 對著「Web.{組態名稱}.config」點右鍵，選擇「預覽和轉換」，可以查看轉換結果。

![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-preview-transform.png?raw=true)
...
完整的 Transform 語法，可以參考「[使用 Visual Studio 部署 Web 專案的 Web.config 轉換語法](https://learn.microsoft.com/en-us/previous-versions/aspnet/dd465326(v=vs.110))」。

#### 發佈

選擇發佈後，會在目標資料夾看到輸出後的檔案，此時會發現產出的「Web.config」是合併後的內容。

![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-publish-output.png?raw=true)
...
![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-slowcheetah-add-transform.png?raw=true)

如果 NuGet 未安裝「Microsoft.VisualStudio.SlowCheetah」，會提醒並自動安裝。

![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-slowcheetah-nuget-prompt.png?raw=true)
...
![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-build-non-web-project.png?raw=true)
...
![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-solution-explorer-structure.png?raw=true)
...
* 還需加入新建的三個 Config 及相關組態檔的檔案連結。
Web 專案選擇加入現有專案。

![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-add-existing-item-menu.png?raw=true)

    使用加入連結的方式來新增外部設定檔及相關的外部組態設定檔。

![](https://github.com/CloudyWing/HackMD-Notes/blob/main/Images/.NET%20Framework%20%E8%A3%A1%EF%BC%8C%E6%9C%89%E9%97%9C%20Web.config%20%28App.config%29%20%E7%9A%84%E6%87%89%E7%94%A8/vs-add-as-link.png?raw=true)
