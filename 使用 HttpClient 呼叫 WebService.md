...
[![hackmd-github-sync-badge](https://hackmd.io/_mHJKdHpQm6Vq4fTERvSug/badge)](https://hackmd.io/_mHJKdHpQm6Vq4fTERvSug)
...
.NET Framework 中常見的作法是使用 WebClient 和 Reflection 的組合來動態產生 WebService 服務的代碼，程式碼如下：
```csharp
