...
![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/include-actual-execution-plan.png?raw=true)

1. 點擊「執行」來執行查詢語法。

![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/execute-query-button.png?raw=true)

1. 查詢完畢後，可以發現額外增加一個「執行計畫」的頁籤，裡面會顯示執行計畫內容，如果有缺漏索引，會有相應的提醒。

![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/execution-plan-tab.png?raw=true)

### 顯示估計執行計畫

如果點擊「顯示估計執行計畫」，不需要點擊「執行」，會直接顯示「執行計畫」，由於沒有真正執行查詢，所以不會有「結果」頁籤顯示。

![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/display-estimated-execution-plan.png?raw=true)

### 補上遺漏的索引

1. 對「執行計畫」按右鍵，選擇「遺漏索引詳細資訊」。

![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/missing-index-details-menu.png?raw=true)

1. 產生包含建立索引語法的視窗，可以使用該語法來補上遺漏的索引。

![](../images/SQL%20Server%20%E6%95%88%E8%83%BD%E8%AA%BF%E6%95%99/create-index-script.png?raw=true)
