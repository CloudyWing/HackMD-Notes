---
title: "Docker Compose 架設 SQL Server 權限問題解決方案"
date: 2025-08-24
lastmod: 2025-11-04
description: "解決使用 Docker Compose 架設 SQL Server 時遇到的檔案權限 (Permission Denied) 問題。說明如何調整 Volume 掛載目錄的擁有者權限 (chown) 以符合容器內 mssql 使用者的需求。"
