---
title: "使用 Docker Compose 安裝 Elasticsearch 與 Kibana"
date: 2025-09-24
lastmod: 2025-11-04
description: "介紹使用 Docker Compose 快速部署 Elasticsearch 與 Kibana 單節點環境。提供完整的 `docker-compose.yml` 與 `.env` 設定範例，並提醒 Volume 權限設定的重要性。"
tags: ["Elastic Stack","Elasticsearch","Docker"]
---
