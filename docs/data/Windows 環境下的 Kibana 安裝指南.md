---
title: "Windows 環境下的 Kibana 安裝指南"
date: 2025-03-18
lastmod: 2025-03-18
description: "記錄在 Windows 環境安裝 Kibana 的步驟。說明目錄結構、`kibana.yml` 設定 (包含 Network Host 與 Elasticsearch 連線帳號 `kibana_system`)，以及解決 SSL 連線問題的經驗。"
tags: ["Elastic Stack"]
---

# Windows 環境下的 Kibana 安裝指南

之前在 [Windows 環境下的單節點 Elasticsearch 安裝指南](Windows%20%E7%92%B0%E5%A2%83%E4%B8%8B%E7%9A%84%E5%96%AE%E7%AF%80%E9%BB%9E%20Elasticsearch%20%E5%AE%89%E8%A3%9D%E6%8C%87%E5%8D%97.md) 撰寫 Elasticsearch 的安裝筆記，之前研究了 2 ~ 3 天，終於成功把 Kibana 環境也架起來了，想說趁還有記憶，趕快也寫一份筆記，雖然後續 SSL 卡關，又拖稿兩週，才把這篇生出來。
...
- 等待啟動完成後，開啟瀏覽器測試：<http://localhost:5601> 或 <https://localhost:5601>。
