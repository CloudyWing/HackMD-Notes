---
title: "使用 CallerArgumentExpression 簡化參數檢核"
date: 2024-10-13
lastmod: 2024-10-13
description: "介紹 C# 10 的 `[CallerArgumentExpression]` 屬性，說明如何將其應用於 `ExceptionUtils` 工具類，在拋出 ArgumentException 時自動擷取參數名稱，簡化參數檢核程式碼。"
tags: [".NET","C#"]
---
