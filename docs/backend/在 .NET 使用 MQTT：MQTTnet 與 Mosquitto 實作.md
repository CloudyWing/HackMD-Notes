---
title: "在 .NET 使用 MQTT：MQTTnet 與 Mosquitto 實作"
date: 2025-11-15
lastmod: 2025-11-15
description: "介紹 MQTT 協定在 .NET 中的應用。教學包含使用 Docker 架設 Mosquitto Broker，以及使用 MQTTnet 套件實作 Publisher 與 Subscriber 的完整流程，適合 IoT 入門開發。"
tags: [".NET","Docker","Mosquitto","MQTT","MQTTnet"]
---
