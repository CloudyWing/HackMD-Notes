---
title: "在 ASP.NET Core MVC 使用 HTML5 實現多檔案上傳"
date: 2022-10-24
lastmod: 2022-10-24
description: "實作 ASP.NET Core MVC 結合 HTML5 與 Axios 的多檔案上傳功能。介紹前端 `FormData` 與 Back-End `IFormFileCollection` 的對接，以及如何監聽 Upload Progress Event 製作進度條。"
tags: [".NET","ASP.NET","ASP.NET Core","Axios"]
---
