---
title: "淺談 Git Commit 規範"
date: 2024-07-23
lastmod: 2024-09-20
description: "介紹 Git Commit Message 的撰寫規範，以 Angular Commit Format 為例。說明 Header (Type, Scope, Summary)、Body 與 Footer 的結構，以及常用的 Commit Types (feat, fix, docs 等)。"
tags: ["Git"]
---
...
上面簡單的介紹現今主流的 Commit 規範，但實際操作時，可能會忘記一些不常用內容，像我自己就經常忘記一些不常用的 Type。而 Git 支援預設的 Commit Template，可以幫助我們統一 Commit 訊息格式。
