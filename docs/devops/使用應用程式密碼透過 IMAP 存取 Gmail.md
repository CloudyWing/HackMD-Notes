---
title: "使用應用程式密碼透過 IMAP 存取 Gmail"
date: 2025-03-05
lastmod: 2025-03-05
description: "解決 Gmail 停用低安全性應用程式存取後，透過 IMAP 讀取信件的問題。教學如何啟用 Google 帳號兩步驗證並產生「應用程式密碼 (App Password)」以供第三方程式連線。"
